...
\vocab{empirical training error} which is 
...
We define the \vocab{generalization error} to be 
...
the input $X$ to $\{0, 1\}$, and the \vocab{empirical risk minimization (ERM)}
...
\begin{proof}
    ...
    Therefore, the \vocab{empirical training error} is 
